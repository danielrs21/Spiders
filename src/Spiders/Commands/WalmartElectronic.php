...
class WalmartElectronic extends Command
{
    ...
    */
    protected $info = [
        'site_name'     => 'Walmart',
        'site_base_url' => 'https://www.walmart.com',
        'site_url'      => 'https://www.walmart.com/browse?cat_id=%s&facet=%s&min_price=1&page=%s#searchProductResult',
        'profit_percent'=> 1.15,
    ...
    protected $tags = [
        ...
        'product_url'           => '.search-result-product-title a',                    // Tag de url de producto en listado
        'name'                  => '.ProductTitle h1 div',                              // Tag del nombre de producto
        'description'           => '.about-desc',                                       // Tag de la descripcion de producto
        ...
        'normal_price'          => '.product-offer-price .price-old .price-group',      // Tag de precio normal
        'special_price'         => '.product-offer-price .prod-PriceHero .price-group', // Tag de precio especial
        'image_first'           => '.prod-ProductImage .prod-hero-image-container img', // Tag de Imagen principal
        'image_second'          => '.prod-ProductImage .slider .slider-frame img',      // Tag de Imagen secundaria
        'manufacturer'          => '.prod-brandName span',                              // Tag de manufacturer o brand 
    ...
    */
    protected $categories = [
        'laptops' => [ 'category_id' => '3944_3951_1089430_132960', 'category_string' => 'DRS/Computers/Laptops' ],
        'usb-drives' => [ 'category_id' => '3944_3951_132959_529295', 'category_string' => 'DRS/Computers/USB Flash Drives'],
        'unlocked-phones' => [ 'category_id' => '1105910_1073085', 'category_string' => 'DRS/Electronics & Office/Cell Phones/Unlocked Phones' ],
        'chargers-adapters' => [ 'category_id' => '1105910_133161_1072306', 'category_string' => 'DRS/Electronics & Office/Cell Phones/Chargers & Adapters'],
        'power-banks' => [ 'category_id' => '1105910_133161_1087421', 'category_string' => 'DRS/Electronics & Office/Cell Phones/Power Banks'],
        'headsets' => [ 'category_id' => '1105910_133161_132901', 'category_string' => 'DRS/Electronics & Office/Cell Phones/Headsets']
    ];
    ...
    */ 
     ...
     */
    protected $shippingValid = [ 'free shipping', 'free 2-day shipping' ];
    ...
    */
    ...
    {
        $this->setName('walmart:electronics')
                ->setDescription('Walmart Electronics Products')
                ->setHelp('Scrapping electronics products from Walmart Store.')
    ...
    */
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $output->writeln('<bg=green;options=bold;fg=white>[ SPIDERS - Walmart Electronics ]</>');
    ...
    */     
    ...
    protected function saveProduct( $product ){
        ...
        if($product_exist) {
            ...
            if(!in_array($product['category'], $cache_categories)) {
                $product['category'] = implode(",",$cache_categories).','.$product['category'];
            }
            /* Se envia a la DB */ 
    ...
    protected function printLog( $output ) {
        ...
        $recordLog->info('++++++ SPIDERS. REPORT FOR SCRAPPING: WALMART ELECTRONICS '.date('Y-m-d H:i:s').' ++++++');
        ...
        $recordLog->info('++++++ END REPORT FOR SCRAPPING: WALMART ELECTRONICS '.date('Y-m-d H:i:s').' ++++++');
